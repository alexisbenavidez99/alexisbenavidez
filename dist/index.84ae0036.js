...
!function(t) {
    ...
    function s(t) {
        var i = void 0;
        return /^#([A-Fa-f0-9]{3}){1,2}$/.test(t) ? (3 === (i = t.substring(1).split("")).length && (i = [
            i[0],
            i[0],
            i[1],
            i[1],
        ...
        return _cc(t, [
            ...
            },
            {
                ...
                value: function(t, s, e) {
                    ...
                    var h = this.gr(this.r, this.o.opacity.center), a = this.gr(this.r, this.o.opacity.edge), n = "c" === this.h ? this.s / 2 : "t" === this.h ? .577 * this.s : "s" === this.h ? .707 * this.s : this.s, o = t.createRadialGradient(this.x, this.y, .01, this.x, this.y, n);
        ...
        return _cc(h, [
            ...
            },
            {
                ...
                value: function() {
                    ...
                    for(var i = 0; i < this.o.ac; i++)this.ps[i].an(this.x, this.o.c.w, this.o.c.h);
                }
            }
        ]), h;
    }();
...
//# sourceMappingURL=index.84ae0036.js.map
